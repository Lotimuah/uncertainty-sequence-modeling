...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument("--env", type=str, default="CarRacing-v0", help="environment ID")
    ...
    group_name = 'gym-{}-{}'.format(env_id, args.algo)
    ...
    wandb.config.update(config['CarRacing-v0'], allow_val_change=True)
    ###################################################################################
