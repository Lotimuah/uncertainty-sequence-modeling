...
class BEAR(AlgoBase):
    ...
    def _update(self, batch: TransitionMiniBatch) -> Dict[str, float]:
        ...
        ####################################################
        CollectLog.log['training/imitator_loss'] = imitator_loss
        ####################################################
        ...
        if self._temp_learning_rate > 0:
            ...
            #######################################################
            CollectLog.log['training/temp_loss'] = temp_loss
            #######################################################
        ...
        if self._alpha_learning_rate > 0:
            ...
            #######################################################
            CollectLog.log['training/alpha_loss'] = alpha_loss
            #######################################################
        ...
        #######################################################
        CollectLog.log['training/critic_loss'] = critic_loss
        #######################################################
        ...
        #######################################################
        CollectLog.log['training/actor_loss'] = actor_loss
        #######################################################
