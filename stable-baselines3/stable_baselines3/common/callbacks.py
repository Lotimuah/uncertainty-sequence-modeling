...
class EvalCallback(EventCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            ############################################
            CollectLog.log_e['eval/return_mean'] = mean_reward
            CollectLog.log_e['eval/return_std'] = std_reward
            CollectLog.log_e['eval/length_mean'] = mean_ep_length
            CollectLog.log_e['eval/length_std'] = std_ep_length

            wandb.log(CollectLog.log_e)
            ############################################
